...
object DataMovies {
    ...
    fun generateMovieList(): List<MovieEntity> {
    ...
    fun generateTvShowList() : List<TvShowEntity> {
    ...
    fun generateRemoteTvShowList() : List<TvShowResponse> {
    ...
    fun generateMovie(movie: MovieEntity, favorited: Boolean): MovieEntity {
        movie.favorited = favorited
        return movie
    }

    fun generateTvShow(tvShow: TvShowEntity, favorited: Boolean): TvShowEntity {
        tvShow.favorited = favorited
        return tvShow
    }
}